...
class SpringAIChatServiceTest {
    ...
    @Mock
    private ObjectProvider<io.github.ngirchev.aibot.ai.springai.retry.metrics.OpenRouterStreamMetricsTracker> openRouterStreamMetricsTrackerProvider;
    ...
    void callChat_returnsSpringAIResponse() {
        ...
        AIBotChatOptions options = new AIBotChatOptions(0.7, 1000, "System", "User", false, Map.of());
    ...
    void streamChat_returnsSpringAIStreamResponse() {
        ...
        AIBotChatOptions options = new AIBotChatOptions(0.7, 1000, null, "Hi", true, Map.of());
        ChatAICommand command = new ChatAICommand(
                java.util.Set.of(ModelCapabilities.CHAT),
