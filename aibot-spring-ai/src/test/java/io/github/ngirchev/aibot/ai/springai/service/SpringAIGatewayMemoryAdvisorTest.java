...
class SpringAIGatewayMemoryAdvisorTest {
    ...
    void setUp() {
        ...
        promptFactory = new SpringAIPromptFactory(
                ...
                mock(io.github.ngirchev.aibot.ai.springai.tool.WebTools.class),
                chatMemory,
                springAIModelType,
        ...
        org.springframework.beans.factory.ObjectProvider<io.github.ngirchev.aibot.ai.springai.retry.metrics.OpenRouterStreamMetricsTracker> objectProvider =
