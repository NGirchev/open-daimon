...
public class SpringAIModelRegistryRefreshScheduler {
    ...
    @Scheduled(
            initialDelayString = "${open-daimon.ai.spring-ai.openrouter-auto-rotation.models.refresh-initial-delay:60s}",
            fixedDelayString = "${open-daimon.ai.spring-ai.openrouter-auto-rotation.models.refresh-interval:1h}"
    )
