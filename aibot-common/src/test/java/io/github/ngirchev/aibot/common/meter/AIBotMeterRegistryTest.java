...
class AIBotMeterRegistryTest {
    ...
    private AIBotMeterRegistry aiBotMeterRegistry;
    ...
    void setUp() {
        ...
        aiBotMeterRegistry = new AIBotMeterRegistry(meterRegistry);
    }
    ...
    void countAndTime_Success() throws Exception {
        ...
        String result = aiBotMeterRegistry.countAndTime(METRIC_PREFIX, () -> "test");
    ...
    void countAndTime_Failure() throws Exception {
        ...
        try {
            aiBotMeterRegistry.countAndTime(METRIC_PREFIX, (Callable<String>) () -> { throw exception; });
        } catch (Exception e) {
