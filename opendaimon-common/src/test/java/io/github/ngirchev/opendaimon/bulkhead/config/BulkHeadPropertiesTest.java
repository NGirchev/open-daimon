...
@TestPropertySource(properties = {
        "open-daimon.common.bulkhead.instances.ADMIN.maxConcurrentCalls=20",
        "open-daimon.common.bulkhead.instances.ADMIN.maxWaitDuration=1s",
        "open-daimon.common.bulkhead.instances.VIP.maxConcurrentCalls=10",
        "open-daimon.common.bulkhead.instances.VIP.maxWaitDuration=1s",
        "open-daimon.common.bulkhead.instances.REGULAR.maxConcurrentCalls=5",
        "open-daimon.common.bulkhead.instances.REGULAR.maxWaitDuration=500ms",
        "open-daimon.common.bulkhead.instances.BLOCKED.maxConcurrentCalls=0",
        "open-daimon.common.bulkhead.instances.BLOCKED.maxWaitDuration=0ms"
})
