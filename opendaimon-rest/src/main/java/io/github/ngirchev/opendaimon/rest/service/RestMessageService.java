...
public class RestMessageService {
     ...
     */
    public String getClientIpFromMetadata(OpenDaimonMessage message) {
     ...
     */
    public String getUserAgentFromMetadata(OpenDaimonMessage message) {
        if (message.getMetadata() == null) {
            return null;
        }
     ...
     */
    public String getEndpointFromMetadata(OpenDaimonMessage message) {
        if (message.getMetadata() == null) {
            return null;
        }
