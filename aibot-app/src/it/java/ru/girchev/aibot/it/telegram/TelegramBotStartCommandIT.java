...
class TelegramBotStartCommandIT {
    ...
    @EntityScan(basePackageClasses = {
            ru.girchev.aibot.common.model.User.class,
            AssistantRole.class,
            TelegramUser.class,
    ...
    static class TestConfig {
        ...
        public AssistantRoleService assistantRoleService() {
            return new AssistantRoleService() {
                @Override
                public Optional<ru.girchev.aibot.common.model.AssistantRole> getActiveRole(ru.girchev.aibot.common.model.User user) {
                    return Optional.empty();
                }

                @Override
                public ru.girchev.aibot.common.model.AssistantRole createOrGetRole(ru.girchev.aibot.common.model.User user, String content) {
                    throw new UnsupportedOperationException("Not needed for this test");
                }

                @Override
                public void setActiveRole(ru.girchev.aibot.common.model.AssistantRole role) {
                    // no-op
                }

                @Override
                public ru.girchev.aibot.common.model.AssistantRole updateActiveRole(ru.girchev.aibot.common.model.User user, String content) {
                    throw new UnsupportedOperationException("Not needed for this test");
                }

                @Override
                public void incrementUsage(ru.girchev.aibot.common.model.AssistantRole role) {
                    // no-op
                }

                @Override
                public List<ru.girchev.aibot.common.model.AssistantRole> getAllUserRoles(ru.girchev.aibot.common.model.User user) {
                    return List.of();
                }

                @Override
                public Optional<ru.girchev.aibot.common.model.AssistantRole> getRoleByVersion(ru.girchev.aibot.common.model.User user, Integer version) {
                    return Optional.empty();
                }
                ...
                @Override
                public List<ru.girchev.aibot.common.model.AssistantRole> findUnusedRoles(OffsetDateTime thresholdDate) {
                    return List.of();
                }

                @Override
                public ru.girchev.aibot.common.model.AssistantRole getOrCreateDefaultRole(ru.girchev.aibot.common.model.User user, String defaultContent) {
                    throw new UnsupportedOperationException("Not needed for this test");
                }

                @Override
                public Optional<ru.girchev.aibot.common.model.AssistantRole> findById(Long roleId) {
                    return Optional.empty();
                }
            };
        }
        ...
        public CommandSyncService commandSyncService() {
            return new CommandSyncService(null, null, null, userId -> UserPriority.REGULAR) {
                @Override
                public <T extends ru.girchev.aibot.common.command.ICommandType, C extends ru.girchev.aibot.common.command.ICommand<T>, R> R syncAndHandle(C command) {
                    throw new UnsupportedOperationException("Not needed for this test");
                }
            };
        }
