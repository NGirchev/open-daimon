...
class TelegramBotStartCommandIT {
    ...
    @EntityScan(basePackageClasses = {
            io.github.ngirchev.aibot.common.model.User.class,
            AssistantRole.class,
            TelegramUser.class,
    ...
    static class TestConfig {
        ...
        public AssistantRoleService assistantRoleService() {
            return new AssistantRoleService() {
                @Override
                public Optional<io.github.ngirchev.aibot.common.model.AssistantRole> getActiveRole(io.github.ngirchev.aibot.common.model.User user) {
                    return Optional.empty();
                }

                @Override
                public io.github.ngirchev.aibot.common.model.AssistantRole createOrGetRole(io.github.ngirchev.aibot.common.model.User user, String content) {
                    throw new UnsupportedOperationException("Not needed for this test");
                }

                @Override
                public void setActiveRole(io.github.ngirchev.aibot.common.model.AssistantRole role) {
                    // no-op
                }

                @Override
                public io.github.ngirchev.aibot.common.model.AssistantRole updateActiveRole(io.github.ngirchev.aibot.common.model.User user, String content) {
                    throw new UnsupportedOperationException("Not needed for this test");
                }

                @Override
                public void incrementUsage(io.github.ngirchev.aibot.common.model.AssistantRole role) {
                    // no-op
                }

                @Override
                public List<io.github.ngirchev.aibot.common.model.AssistantRole> getAllUserRoles(io.github.ngirchev.aibot.common.model.User user) {
                    return List.of();
                }

                @Override
                public Optional<io.github.ngirchev.aibot.common.model.AssistantRole> getRoleByVersion(io.github.ngirchev.aibot.common.model.User user, Integer version) {
                    return Optional.empty();
                }
                ...
                @Override
                public List<io.github.ngirchev.aibot.common.model.AssistantRole> findUnusedRoles(OffsetDateTime thresholdDate) {
                    return List.of();
                }

                @Override
                public io.github.ngirchev.aibot.common.model.AssistantRole getOrCreateDefaultRole(io.github.ngirchev.aibot.common.model.User user, String defaultContent) {
                    throw new UnsupportedOperationException("Not needed for this test");
                }

                @Override
                public Optional<io.github.ngirchev.aibot.common.model.AssistantRole> findById(Long roleId) {
                    return Optional.empty();
                }
            };
        }
