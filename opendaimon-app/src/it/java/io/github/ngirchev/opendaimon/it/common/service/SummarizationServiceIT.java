package io.github.ngirchev.opendaimon.it.common.service;
...
import io.github.ngirchev.opendaimon.common.config.AsyncConfig;
...
class SummarizationServiceIT {
    ...
    void setUp() {
        ...
        // Create test thread
        testThread = threadService.createNewThread(testUser);
    ...
    void whenSummarizeThreadAsync_thenOnlyOldRequestsAreSummarized() {
        ...
        List<OpenDaimonMessage> allMessages =
