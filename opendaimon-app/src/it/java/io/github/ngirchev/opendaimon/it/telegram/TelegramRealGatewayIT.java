 ...
 *
 * <p><b>Goal:</b> Test opendaimon-telegram module end-to-end without mocks —
...
@TestPropertySource(properties = {
        ...
        "open-daimon.telegram.token=${TELEGRAM_TOKEN}",
        "open-daimon.telegram.username=${TELEGRAM_USERNAME}",
...
class TelegramRealGatewayIT {
    ...
    //   - open-daimon.common.storage.enabled=true
    //   - open-daimon.telegram.file-upload.enabled=true
     ...
     *       <ul>
     *         <li>open-daimon.common.storage.enabled=true</li>
     *         <li>open-daimon.telegram.file-upload.enabled=true</li>
     *       </ul>
     *   </li>
    ...
    void photoCommand_savesToMinioStorage() {
        ...
        assertThat(fileServiceProvider)
                .as("TelegramFileService must be available (enable open-daimon.telegram.file-upload.enabled=true)")
                .isNotNull();
        assertThat(storageServiceProvider)
                .as("FileStorageService must be available (enable open-daimon.common.storage.enabled=true)")
                .isNotNull();
