...
class TelegramOpenDaimonMessageRepositoryIT {
    ...
    private OpenDaimonMessage createUserMessage(TelegramUser user, ConversationThread thread, int sequenceNumber, String content) {
    ...
    private OpenDaimonMessage createAssistantMessage(TelegramUser user, ConversationThread thread,
