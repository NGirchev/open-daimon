...
@TestPropertySource(properties = {
        ...
        "open-daimon.ai.spring-ai.web-tools.user-agent=OpenDaimonBot/1.0 (streaming-it)",
        "open-daimon.ai.spring-ai.url-check.timeout-ms=2000",
        "open-daimon.ai.spring-ai.url-check.max-urls-per-answer=5",
        "open-daimon.ai.spring-ai.url-check.cache-ttl-minutes=10",
