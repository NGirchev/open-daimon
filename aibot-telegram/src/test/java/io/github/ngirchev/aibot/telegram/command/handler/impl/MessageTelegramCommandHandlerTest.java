...
import static io.github.ngirchev.aibot.common.ai.LlmParamNames.MESSAGE;
import static io.github.ngirchev.aibot.common.ai.LlmParamNames.CONTENT;
...
class MessageTelegramCommandHandlerTest {
    ...
    @Mock
    private io.github.ngirchev.aibot.common.service.AIGateway aiGateway;
    ...
    void canHandle_whenNotTelegramCommand_thenFalse() {
        io.github.ngirchev.aibot.common.command.ICommand<io.github.ngirchev.aibot.telegram.command.TelegramCommandType> other =
                mock(io.github.ngirchev.aibot.common.command.ICommand.class);
    ...
    void handleInner_whenGenericException_thenSavesErrorAndSendsMessage() throws Exception {
        ...
        verify(telegramMessageService).saveAssistantErrorMessage(eq(telegramUser), eq("An error occurred while processing your request"), anyString(), eq("Role"), isNull());
        verify(telegramBot).sendErrorMessage(eq(CHAT_ID), eq("An error occurred while processing your request"), eq(1));
    }
